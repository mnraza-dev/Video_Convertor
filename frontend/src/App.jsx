...
const App = () => {
  return (
    <div className="bg-amber-100 min-h-screen flex flex-col justify-center items-center">
      ...
      <form className="bg-amber-300 p-5 w-full h-[300px] rounded-xl mt-6 shadow-2xl drop-shadow-2xl flex flex-col justify-center items-center  gap-4">
        ...
        <button className="w-fit bg-amber-900 text-amber-100 px-4 py-2 rounded-lg">
          Convert
        </button>
      </form>
    </div>
